...
TwitterRequest* RequestCreator::list_statuses_by_names_request( const std::string& slug, uid_t owner_screen_name, int count, int since_id, int max_id, bool include_entities, bool include_rts ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::STATUSES );
...
TwitterRequest* RequestCreator::destroy_list_member_by_names_request( const std::string& slug, uid_t screen_name ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::MEMBERS );
	req->set_POST_data( REC_ARGS_2( slug, screen_name ) );
	return req;
}

TwitterRequest* RequestCreator::list_membership_request( const std::string& screen_name, cid_t cursor ) {
...
TwitterRequest* RequestCreator::list_suscribers_request( const std::string& slug, const std::string& screen_name, cid_t cursor, bool include_entities, bool skip_status ) {
...
TwitterRequest* RequestCreator::subscribe_to_list_request( const std::string& slug, const std::string& owner_screen_name ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::SUBSCRIBERS );
...
TwitterRequest* RequestCreator::show_user_is_suscriber_by_names_request( const std::string& screen_name, lid_t slug, const std::string& owner_screen_name, bool include_entities, bool skip_status ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::SUBSCRIBERS );
...
TwitterRequest* RequestCreator::unsubscribe_from_list_request( const std::string& slug, const std::string& owner_screen_name ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::SUBSCRIBERS );
	req->set_POST_data( REC_ARGS_2( slug, owner_screen_name ) );
	return req;
}

TwitterRequest* RequestCreator::subscribe_to_list_multi_by_ids_request( lid_t list_id, const std::string& user_id ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::MEMBERS );
	req->set_POST_data( REC_ARGS_2( list_id, user_id ) );
	return req;
}

TwitterRequest* RequestCreator::subscribe_to_list_multi_by_ids_request( const std::string& slug, const std::string& owner_screen_name, const std::string& screen_name ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::MEMBERS );
...
TwitterRequest* RequestCreator::show_user_is_member_by_names_request( const std::string& slug, const std::string& owner_screen_name, const std::string& screen_name, bool include_entities, bool skip_status ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::MEMBERS );
...
TwitterRequest* RequestCreator::list_members_by_name_request( const std::string& slug, const std::string& owner_screen_name, cid_t cursor, bool include_entities, bool skip_status ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::MEMBERS );
...
TwitterRequest* RequestCreator::join_list_request( const std::string& screen_name, const std::string& slug, const std::string& owner_screen_name ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::MEMBERS );
...
TwitterRequest* RequestCreator::update_list_by_id_request( lid_t list_id, const std::string& name, const std::string& description, const std::string& mode ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::UPDATE );
	req->set_POST_data( REC_ARGS_4( list_id, name, description, mode ) );
	return req;
}

TwitterRequest* RequestCreator::update_list_by_name_request( const std::string& slug, const std::string& owner_screen_name, const std::string& name, const std::string& description, const std::string& mode ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::UPDATE );
	req->set_POST_data( REC_ARGS_5( slug, owner_screen_name, name, description, mode ) );
	return req;
}

TwitterRequest* RequestCreator::create_list_request( const std::string& name, const std::string& description, bool mode ) {
...
TwitterRequest* RequestCreator::show_list_request( const std::string& slug, const std::string& owner_screen_name ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::SHOW );
...
TwitterRequest* RequestCreator::lists_subscription_by_screen_name_request( const std::string& screen_name, int count, cid_t cursor ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::SUBSCRIPTIONS );
	req->set_GET_data( REC_ARGS_3( screen_name, count, cursor ) );
	return req;
}

TwitterRequest* RequestCreator::expulse_from_list_by_ids_request( lid_t list_id, const std::string& user_id ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::MEMBERS );
	req->set_POST_data( REC_ARGS_2( list_id, user_id ) );
	return req;
}

TwitterRequest* RequestCreator::expulse_from_list_by_names_request( const std::string& slug, const std::string& owner_screen_name, const std::string& screen_name ) {
	TwitterRequest* req = __make_a_request( TwitterConsts::LISTS::MEMBERS );
	req->set_POST_data( REC_ARGS_3( slug, owner_screen_name, screen_name ) );
	return req;
}
